...
const Footer = () => {
  return (
    <div className='w-full flex justify-center pt-16 pb-32 bg-stone-50 dark:bg-dark2 mt-16'>
      ...
      <a className="rounded-3xl flex justify-center items-center text-link-border text-xs py-1.5 px-3 border border-purple-400  hover:border-purple-600 dark:text-link-border-dark dark:hover:border-amber-200  dark:border-link-border-dark sm:text-sm hover:bg-link-bg dark:hover:bg-link-bg-dark" target="_blank" href="https://t.me/ulugbekChannel">Get Newsletter</a>
      </div>
